...
const EditProfile = () =>{
        ...
        const handleSubmit = (e)=>{
            ...
            if(username.length < 3){
                return toast.error("Username must be more than three letters long")
            }

            if(bio.length > bioLimit){
                return toast.error(`Bio must not be less than ${bioLimit}`)
            }
                            ...
                            <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                                ...
                                <div className="max-lg:center mb-5">
                                        <label htmlFor="uploadImg" id="profileImgLabel" className="relative block w-48 h-48 bg-grey rounded-full overflow-hidden">
                                                <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center text-white bg-black/30 opacity-0
                                ...
                                <div className="w-full">
                                            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                                ...
                                                <div>
                                                    <InputBox name="email" type="email" value={email} placeholder="E-mail"
                                                        disable={true} icon="bi-envelope"
                                                    />
                                                </div>
                                            </div>
                                                ...
                                                <div className="md:grid md:grid-cols-2 gap-x-6">
                                                    {
                                                        Object.keys(social_links).map((key, i)=>{
                                                            ...
                                                            return <InputBox key={i}  name={key}  type="text" value={link} placeholder="https://" icon={"bi  " + (key != "website" ? "bi-" + key : "bi-globe")}/>
                                                        })
