...
const NotificationCard = ({ data, index, notificationState }) =>{
    ...
    let{reply, createdAt , seen ,type,  comment , replied_on_comment, user, user:{personal_info:{fullname, username, profile_img}} , 
                        ...
                        <img src={profile_img} className="w-14 h-14 flex-none rounded-full"/>
                            <div className="w-full">
                                <h1 className="font-medium text-xl text-dark-grey">
                                    ...
                                    <Link to={`/user/${username}`} className="mx-l text-black underline">@{username}</Link>
